 ...
 */
module.exports = [
  {value: 'XRP', name: 'Ripples', order: 11},
  {value: 'BTC', name: 'Bitcoin', order: 10},
  {value: 'JPY', name: 'Japanese Yen', order: 9},
  {value: 'CNY', name: 'Chinese Yuan', order: 8}, 
  {value: 'EUR', name: 'Euro', order: 7},
  {value: 'GBP', name: 'British Pound', order: 6},
  {value: 'AUD', name: 'Australian Dollar', order: 5},
  {value: 'NZD', name: 'New Zealand Dollar', order: 4},
  {value: 'USD', name: 'US Dollar', order: 3},
