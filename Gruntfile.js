    ...
    copy: {
      ...
      web: {
        files: [
          ...
          {expand: true, src: ['/res/fonts/*'], dest: 'build/bundle/web'},
      ...
      nw_desktop: {
        files: [
          ...
          {expand: true, src: ['/res/fonts/*'], dest: 'build/bundle/nw-desktop'},
      ...
      nw_desktop_debug: {
        files: [
          ...
          {expand: true, src: ['/res/fonts/*'], dest: 'build/bundle/nw-desktop-debug'},
